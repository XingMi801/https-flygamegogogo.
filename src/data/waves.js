...
const WavesData = {
  ...
  stage2: {
    ...
    starGoals: ['no_damage', 'full_clear', 'time_limit', 'perfect_boss'],
    waves: [
      { time: 0.5, type: 'zigzag', count: 4, pattern: 'arc',    interval: 0.5, from: 'top' },
      { time: 5.0, type: 'arc',    count: 5, pattern: 'arc',    interval: 0.5, from: 'top' },
      { time: 10.0, type: 'ram',    count: 3, pattern: 'line',  interval: 1.0, from: 'top' },
      { time: 15.0, type: 'bomber',count: 3, pattern: 'line',  interval: 0.9, from: 'top' },
      { time: 21.0, type: 'zigzag',count: 6, pattern: 'arc',    interval: 0.4, from: 'top' },
      { time: 27.0, type: 'arc',    count: 5, pattern: 'arc',    interval: 0.45, from: 'top' },
      { time: 33.0, type: 'elite',  count: 1, pattern: 'arc',   from: 'top' },
      { time: 39.0, type: 'ram',    count: 4, pattern: 'line',  interval: 0.7, from: 'top' },
      // 喘息 + 道具（去掉武器切换，保留盾/僚机）
      { time: 45.0, type: 'grunt',  count: 2, pattern: 'line',  interval: 1.0, from: 'top', dropGuaranteed: 'shield' },
      { time: 47.0, type: 'grunt',  count: 2, pattern: 'line',  interval: 1.0, from: 'top', dropGuaranteed: 'option' },
      { time: 50.0, type: 'zigzag', count: 7, pattern: 'arc',   interval: 0.35, from: 'top' },
      { time: 57.0, type: 'arc',    count: 6, pattern: 'line',   interval: 0.35, from: 'top' },
      { time: 64.0, type: 'bomber', count: 5, pattern: 'line',  interval: 0.5, from: 'top' },
      { time: 71.0, type: 'elite',  count: 2, pattern: 'arc',   interval: 0.9, from: 'top' },
      { time: 78.0, type: 'zigzag', count: 7, pattern: 'arc',  interval: 0.35, from: 'top' },
      // 喘息
      { time: 84.0, type: 'grunt',  count: 2, pattern: 'line', interval: 1.0, from: 'top', dropGuaranteed: 'P' },
      { time: 86.0, type: 'grunt',  count: 2, pattern: 'line', interval: 1.0, from: 'top', dropGuaranteed: 'bomb' },
      { time: 88.0, type: 'grunt',  count: 2, pattern: 'line', interval: 1.0, from: 'top', dropGuaranteed: 'energy' },
      // 92s 触发 Boss
      { time: 92.0, boss: 'boss_stage2' },
    ],
  },
  ...
  stage3: {
    ...
    waves: [
      ...
      { time: 5.0, type: 'zigzag',count: 6, pattern: 'arc',   interval: 0.4, from: 'top' },
      { time: 11.0, type: 'ram',    count: 4, pattern: 'line', interval: 0.7, from: 'top' },
      { time: 17.0, type: 'bomber',count: 5, pattern: 'line',interval: 0.5, from: 'top' },
      { time: 24.0, type: 'arc',   count: 7,pattern: 'arc',  interval: 0.35, from: 'top' },
      { time: 31.0, type: 'elite', count: 2, pattern: 'arc',  interval: 0.9, from: 'top' },
      { time: 38.0, type: 'zigzag',count: 8,pattern: 'arc',  interval: 0.35, from: 'top' },
      { time: 45.0, type: 'ram',   count: 6,pattern: 'line', interval: 0.45, from: 'top' },
      { time: 52.0, type: 'bomber',count: 6,pattern: 'line', interval: 0.45, from: 'top' },
      // 喘息 + 道具
      { time: 59.0, type: 'grunt', count: 2, pattern: 'line', interval: 1.0, from: 'top', dropGuaranteed: 'P' },
      { time: 61.0, type: 'grunt', count: 2, pattern: 'line', interval: 1.0, from: 'top', dropGuaranteed: 'shield' },
      { time: 63.0, type: 'grunt', count: 2, pattern: 'line', interval: 1.0, from: 'top', dropGuaranteed: 'bomb' },
      { time: 65.0, type: 'grunt', count: 2, pattern: 'line', interval: 1.0, from: 'top', dropGuaranteed: 'option' },
      { time: 68.0, type: 'zigzag',count: 9,pattern: 'arc',  interval: 0.3, from: 'top' },
      { time: 76.0, type: 'arc',   count: 8,pattern: 'arc',  interval: 0.3, from: 'top' },
      { time: 84.0, type: 'elite', count: 3, pattern: 'arc',  interval: 0.7, from: 'top' },
      { time: 92.0, type: 'zigzag',count: 9,pattern: 'arc', interval: 0.3, from: 'top' },
      { time: 100.0, type: 'bomber',count: 7,pattern: 'line',interval: 0.4, from: 'top' },
      // Boss 前最后喘息
      { time: 106.0, type: 'grunt', count: 2, pattern: 'line', interval: 1.0, from: 'top', dropGuaranteed: 'P' },
      { time: 108.0, type: 'grunt', count: 2, pattern: 'line', interval: 1.0, from: 'top', dropGuaranteed: 'energy' },
      { time: 110.0, type: 'grunt', count: 2, pattern: 'line', interval: 1.0, from: 'top', dropGuaranteed: 'shield' },
      // 113s 触发 Boss
      { time: 113.0, boss: 'boss_stage3' },
    ],
  },
